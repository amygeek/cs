...
class MinHeap {
    ...
    // return l child of A.get(i)
    private int left(int i) {
        return 2 * i + 1;
    }

    // return r child of A.get(i)
    ...
    // Recursive Heapify-down procedure: trigger by remove operation
    // Here the node at index i and its two direct children violates the heap property
    private void heapify_down(int i) {
        // get l and r child of node at index i
        int l = left(i);
        int r = right(i);

        int smallest = i;

        // compare A.get(i) with its l and r child
        // and find smallest value
        if (l < size() && A.get(l) < A.get(i)) {
            smallest = l;
        }

        if (r < size() && A.get(r) < A.get(smallest)) {
            smallest = r;
        }
    ...
    // Recursive Heapify-up procedure: trigger by add operation
    ...
    public Integer poll() {
        try {
            ...
            // return root element
            return root;
        } catch (Exception ex) {  // catch and print the exception
