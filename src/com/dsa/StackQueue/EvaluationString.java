...
public class EvaluationString
{
    ...
    {
        System.out.println(EvaluationString.evaluate("10 + 2 * 6"));
        System.out.println(EvaluationString.evaluate("100 * 2 + 12"));
        System.out.println(EvaluationString.evaluate("100 * ( 2 + 12 )"));
        System.out.println(EvaluationString.evaluate("100 * ( 2 + 12 ) / 14"));
    }
}